...
//         <div className="bg-white h-screen w-screen flex flex-col gap-20">

       
//         <p className="flex justify-center text-center text-orange-500 text-5xl mt-10 font-Barriecito">
//           Trending Recipes
//         </p>
//          <div className="bg-white flex flex-col justify-center items-center lg:flex-row lg:gap-20 md:flex-row md:gap-20">
